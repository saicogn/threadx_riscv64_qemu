...
#QEMU_DEPEND_OBJS += $(QEMU_DEPEND_SRCS:%.c=./tx/%.o)

PORT_C_SRC = \
my_memset.c \
port_specific_pre_initialization.c \
tx_timer_interrupt.c \
...
PORT_ASM_OBJS := $(PORT_ASM_SRC:%.S=./tx/%.o)
PORT_C_OBJS := $(PORT_C_SRC:%.c=./tx/%.o)
PORT_OBJS := ${PORT_ASM_OBJS} ${PORT_C_OBJS}
...
GENERIC_OBJS = $(GENERIC_SRCS:%.c=./tx/generic/%.o)
